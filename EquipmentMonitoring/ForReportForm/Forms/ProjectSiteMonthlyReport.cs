using EquipmentMonitoring.AllForm.Reports;
...
{
    public partial class ProjectSiteMonthlyReport : Form
    {
        ...
        public ProjectSiteMonthlyReport()
        {
            InitializeComponent();
        }
        ...
        private void ProjectSiteMonthlyReport_Load(object sender, EventArgs e)
        {
