...
{
    partial class TruckOverallReport
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            reportDataSource3.Value = this.maintenanceDataSet08132019BindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource3);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "EquipmentMonitoring.ForReportForm.RdlcForm.TruckOverlAllReport.rdlc";
            ...
            this.Name = "TruckOverallReport";
            this.Text = "Truck and Heavy Equipment Overall Report";
            this.Load += new System.EventHandler(this.TruckOverallReport_Load);
